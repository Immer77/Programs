...
$WindowPositionsX = @(1000,0,300,0,300,0,300)
$WindowPositionsY = @(100,0,500,0,300,0,300)
$WindowSizeX = @(100,200,1000,0,300,0,300)
$WindowSizeY = @(100,200,500,0,300,0,300)
...
$ProcessList = Get-Process msedge | Where-Object {$_.mainWindowTitle} 
For ($i = 0;$i -le ($ProcessList.count);$i++){
$ProcessList[$i] | Set-Window -X $WindowPositionsX[$i] -Y $WindowPositionsY[$i] -Width $WindowSizeX[$i] -height $WindowSizeY[$i]
Write-Output $i
