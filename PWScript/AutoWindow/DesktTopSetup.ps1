...
$processses = Get-Process firefox
 
$processses[0] | Set-Window -X 0 -Y 0 -Width 1000 -Height 500
$processses[1] | Set-Window -X 0 -Y 0 -Width 100 -Height 200
$processses[2] | Set-Window -X 0 -Y 0 -Width 100 -Height 200
#>


Get-Process powershell | Set-Window -Width 974 -Height 1170 -X 2870 -Y 0
Start-Sleep -ms 100 
Get-Process powershell_ise | Set-Window -Width 974 -Height 1170 -X 1912 -Y 0 